...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    <?php if ($this->session->userdata('ses_idLevel') == 'Administrator') { ?>
      <li>
        <a class="app-menu__item <?php if ($this->uri->segment(2) == "Welcome" && $this->uri->segment(3) == "") {
                                    echo "active";
                                  } ?>" href="<?php echo base_url('Administrator/Welcome') ?>">
      ...
      <li>
        <a class="app-menu__item <?php if ($this->uri->segment(2) == "Data_lowongan") {
                                    echo "active";
                                  } ?>" href="<?php echo base_url('Administrator/Data_lowongan') ?>">
      ...
      <li>
        <a class="app-menu__item  <?php if ($this->uri->segment(2) == "Data_nilai") {
                                    echo "active";
                                  } ?>" href="<?php echo base_url('Administrator/Data_nilai/') ?>">
          <i class="app-menu__icon fa fa-wpforms"></i><span class="app-menu__label">Nilai Pelamar </span>
        </a>
      </li>
      <li class="treeview <?php if ($this->uri->segment(2) == "Quiz") {
                            echo "is-expanded";
                          } ?>">
        ...
        <ul class="treeview-menu">
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "pendaftar_quiz") {
                                      echo "active";
                                    } ?>"
      ...
      <li class="treeview <?php if ($this->uri->segment(2) == "Data_Pelatihan") {
        ...
        <ul class="treeview-menu">
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "admin_berkas") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "index") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "pendaftar") {
                                      echo "active";
                                    } ?>"
      ...
      <li class="treeview <?php if ($this->uri->segment(2) == "Data_ujian") {
        ...
        <ul class="treeview-menu" style="overflow-y: auto;">
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_holland") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_skd") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_cepat") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_tray") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_disc") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_essay") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_hitung") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_kasus") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "studi_kasus_mekanik_mesin") {
                                      echo "active";
                                    } ?>"
              href="<?php echo base_url('Administrator/manage_ujian/studi_kasus_mekanik_mesin') ?>">
              <i class="icon fa fa-circle-o"></i> Studi Kasus Mekanik Mesin
            </a>
          </li>
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "studi_kasus_mekanik_pendingin") {
                                      echo "active";
                                    } ?>"
              href="<?php echo base_url('Administrator/manage_ujian/studi_kasus_mekanik_pendingin') ?>">
              <i class="icon fa fa-circle-o"></i> Studi Kasus Mekanik Pendingin
            </a>
          </li>
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_kasus2") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_kasus_m") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_kasus_ldg") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_leadership") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_msdt") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_rmib_pria") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_rmib_wanita") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_studibank") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_talent") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_army") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_tkp") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_inggris") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_tkb_accounting") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_tkb_bussinessdevelopment") {
                                      echo "active";
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_tkb_trainingoperation") {
                                      echo "active";
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_tkb_projectadministration") {
                                      echo "active";
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_tkb_frontliner") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_tpa") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_tpa2") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_grafis") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_kontrak_psikologis") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "ujian_epps") {
                                      echo "active";
                                    } ?>"
        ...
        <ul class="treeview-menu">
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "Soal_cfit" || $this->uri->segment(2) == "Soal_cfit") {
                                      echo "active";
                                    } ?>" href="<?php echo base_url('Soal/Soal_cfit') ?>">
              <i class="icon fa fa-circle-o"></i> CFIT
            </a>
          </li>
          <li>
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(2) == "Soal_papi") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(2) == "Soal_epps") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(2) == "Soal_inggris") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(2) == "Soal_tkb_accounting") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(2) == "Soal_tkb_bussiness_development") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(2) == "Soal_tkb_training_operation") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(2) == "Soal_tkb_project_administration") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(2) == "Soal_tpa") {
                                      echo "active";
                                    } ?>"
      ...
      <li>
        <a class="app-menu__item  <?php if (
                                    $this->uri->segment(3) == "data_faq" ||
                                    $this->uri->segment(3) == "tambahdata_faq" || $this->uri->segment(3) == "edit_faq"
                                  ) {
                                    echo "active";
                                  } ?>"
      ...
      <li class="treeview <?php if (
                            $this->uri->segment(3) == "data_level" || $this->uri->segment(3) == "data_admin" ||
                            $this->uri->segment(3) == "data_perusahaan" || $this->uri->segment(3) == "data_psikolog" ||
                            $this->uri->segment(3) == "data_pelamar"
                          ) {
                            echo "is-expanded";
                          } ?>">
        ...
        <ul class="treeview-menu">
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "data_level") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "data_admin") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "data_perusahaan") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "data_psikolog") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="treeview-item <?php if ($this->uri->segment(3) == "data_pelamar") {
                                      echo "active";
                                    } ?>"
          ...
          <li>
            <a class="app-menu__item <?php if ($this->uri->segment(2) == "sync_login_sso") {
                                        echo "active";
                                      } ?>"
    ...
    <?php } else if ($this->session->userdata('ses_idLevel') == 'Admin Sdm') { ?>
      <li>
        <a class="app-menu__item  <?php if ($this->uri->segment(2) == "Dashboard") {
                                    echo "active";
                                  } ?>"
      ...
      <li>
        <a class="app-menu__item <?php if ($this->uri->segment(2) == "Data_jadwal") {
                                    echo "active";
                                  } ?>"
    ...
    <?php } else if ($this->session->userdata('ses_idLevel') == 'Psikolog') { ?>
      <li>
        <a class="app-menu__item <?php if ($this->uri->segment(2) == "Welcome") {
                                    echo "active";
                                  } ?>"
          href="<?php echo base_url('Administrator/Welcome') ?>"><i class="app-menu__icon fa fa-dashboard"></i>
          <span class="app-menu__label">Dashboard</span>
