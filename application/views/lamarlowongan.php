					...
					<form action="<?php echo base_url('Pelamar/Lamaran/apply') ?>" method="post">
						...
						<div class="form-group">
							...
							<?php if ($jenis_mot == 'Lowongan Kerja' || $jenis_mot == 'Kenaikan Jabatan') { ?>
								<label class="label-group" style="margin-top: 3%">3. Berapa gaji yang anda inginkan? (* sebutkan nominalnya)</label>

								<input type="number" class="form-control" name="gaji">
							<?php } else { ?>
									<input type="hidden" class="form-control" name="gaji" value="0">
							<?php } ?>
