...
$skd = $this->db->query("SELECT * FROM tb_ujian_skd WHERE `status`='aktif'")->result();
$holland = $this->db->query("SELECT * FROM tb_ujian_holland WHERE `status`='aktif'")->result();
$cepat = $this->db->query("SELECT * FROM tb_ujian_cepat WHERE `status`='aktif'")->result();
$tray = $this->db->query("SELECT * FROM tb_ujian_tray WHERE `status`='aktif'")->result();
$army = $this->db->query("SELECT * FROM tb_ujian_army WHERE `status`='aktif'")->result();
...
$kasus2 = $this->db->query("SELECT * FROM tb_ujian_kasus2 WHERE `status`='aktif'")->result();
...
$tkp = $this->db->query("SELECT * FROM tb_ujian_tkp WHERE `status`='aktif'")->result();
...
$tpa_kuanti2 = $this->db->query("SELECT * FROM tb_ujian_tpa_kuantitatif2 WHERE `status`='aktif'")->result();
$tpa_pena2 = $this->db->query("SELECT * FROM tb_ujian_tpa_penalaran2 WHERE `status`='aktif'")->result();
$tpa_ver2 = $this->db->query("SELECT * FROM tb_ujian_tpa_verbal2 WHERE `status`='aktif'")->result();
