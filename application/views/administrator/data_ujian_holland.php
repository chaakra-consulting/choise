                  ...
                  <div class="modal fade" id="myModal2<?php echo $modal ?>" role="dialog">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div>
                          <a href="<?php echo base_url('Administrator/Data_ujian/hapus_ujian_holland/' . $key['id_ujian_holland']) ?>" title="Hapus Data"><button type="button" class="btn btn-danger" style="margin-left: 170px;"><i class="fa fa-trash"></i> Hapus</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="<?php echo base_url('Administrator/Data_ujian/hentikan_ujian_holland/' . $key['id_ujian_holland']) ?>" title="Hentikan ujian"><button type="button" class="btn btn-dark" style="margin-left: 170px;"><i class="fa fa-stop text-danger"></i> Hentikan ujian</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
