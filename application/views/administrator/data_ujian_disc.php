...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-clipboard"></i> Ujian DISC</h1>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <a href="<?php echo base_url('Administrator/Data_ujian/tambahdata_disc') ?>" class="btn btn-primary" style="margin-bottom: 2%;">Tambah Data</a>
        <div id="notifikasi">
                  ...
                  <div class="modal fade" id="myModal2<?php echo $modal ?>" role="dialog">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div>
                          <a href="<?php echo base_url('Administrator/Data_ujian/hapus_ujian_disc/' . $key['id_ujian_disc']) ?>" title="Hapus Data"><button type="button" class="btn btn-danger" style="margin-left: 170px;"><i class="fa fa-trash"></i> Hapus</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
