...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('administrator/kupon_talent_test'); ?>">Kupon Talent Test</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form action="<?php echo base_url('administrator/kupon_talent_test/create'); ?>" method="post">
