...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo site_url('administrator/KuponTalentTest'); ?>">Kupon Talent Test</a></li>
            ...
            <div class="tile">
                ...
                <div class="tile-body">
                    <form action="<?php echo site_url('administrator/KuponTalentTest/create'); ?>" method="post">
                        ...
                        <a href="<?php echo site_url('administrator/KuponTalentTest'); ?>" class="btn btn-secondary">Batal</a>
                    </form>
                </div>
            </div>
        </div>
