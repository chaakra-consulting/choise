...
<main class="app-content">
  ...
  <div class="app-title">
    ...
    <div>
      ...
      <h1><i class="fa fa-th-list"></i> Bank Soal TPA 2</h1>
    ...
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#">Bank Soal TPA 2</a></li>
          ...
          <div class="tab-content">
            <div id="seksi1" class="tab-pane fade in active">
              ...
              ?>
                ...
                <form action="<?php echo base_url('Administrator/Data_ujian/updatetpa2_1') ?>" method="post">
            ...
            <div id="seksi2" class="tab-pane fade in">
              ...
              ?>
                ...
                <form action="<?php echo base_url('Administrator/Data_ujian/updatetpa2_2') ?>" method="post">
            ...
            <div id="seksi3" class="tab-pane fade in">
              ...
              ?>
                ...
                <form action="<?php echo base_url('Administrator/Data_ujian/updatetpa2_3') ?>" method="post">
