                  ...
                  <div class="modal fade" id="myModal2<?php echo $modal ?>" role="dialog">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div>
                          <a href="<?php echo base_url('Administrator/Data_ujian/hapus_ujian_essay/' . $key['id_ujian_essay']) ?>" title="Hapus Data"><button type="button" class="btn btn-danger" style="margin-left: 170px;"><i class="fa fa-trash"></i> Hapus</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
