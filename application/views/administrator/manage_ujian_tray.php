...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-edit"></i>TRAY</h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">User</li>
      <li class="breadcrumb-item"><a href="#">Manage TRAY</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">Manage TRAY</h3>
        <div class="tile-body">
          <div id="notifikasi">
          ...
          <div class="tile-body">
            ...
            ?>
              ...
              <form action="<?php echo base_url('Administrator/Data_ujian/updatetray') ?>" method="post">
                ...
                <div class="form-group">
                  <label class="control-label">Waktu Ilustrasi (Menit)</label>
                  <input class="form-control" name="waktu_latihan" value="<?php echo (strtotime($key['end_lat']) - strtotime($key['start_lat'])) / 60 ?>" type="text" required>
                </div>
                <div class="form-group">
                  <label class="control-label">Waktu Ujian (Menit)</label>
                  <input class="form-control" name="waktu_ujian" value="<?php echo (strtotime($key['end_uji']) - strtotime($key['start_uji'])) / 60 ?>" type="text" required>
                </div>
                <div class="form-group">
                  <label class="control-label">Waktu Soal (Menit)</label>
                  <input class="form-control" name="waktu_soal" value="<?php echo (strtotime($key['end_soal']) - strtotime($key['start_soal'])) / 60 ?>" type="text" required>
                </div>
                <div class="form-group">
