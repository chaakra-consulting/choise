...
<div class="col-sm-12 main">
	...
	<div class="col-sm-12" style="background-color: #fff; padding-top: 10px; padding-bottom: 20px; padding-right: 10px; padding-left: 10px; margin-bottom: 20px; border-radius: 5px;">
		<div class="col-sm-12" style="background-color: #fff; padding-top: 10px; padding-bottom: 10px; padding-left: 20px; padding-right: 20px; border-radius: 5px;">
			<div class="col-sm-12">
				...
				<div class="form-check col-sm-1 text-center" style="margin-top: 5px;">
					...
					<center>
						<img src="<?php  echo base_url('assets3/images/CFIT 2a/Tes 3/Contoh 2/a.png') ?>" class="img-responsive" alt="" style="width: 50px; border-radius: 5px;">
					</center>
				</div>
				<div style="padding-top: 3.9%">
					<p> Jawaban yang benar (Karena kotak di atasnya memiliki satu garis miring.)</p>
				</div>
			</div>
		...
		<div class="col-sm-12 button-lm-tittle justify-content-center text-center" style="margin-top: 20px;">
			<a href="<?php  echo base_url('Pelamar/Ujian/start_ujian_cfit_2a_subtes_3/'.$id_ujian.'/1') ?>" class="btn btn-primary mr-2 mb-2">Mulai Sekarang</a>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	var x = setInterval(function() {
		...
		if (distance < 0) {
			...
			window.location.href = '<?php echo base_url('Pelamar/Ujian/start_ujian_cfit_2a_subtes_3/'.$idUjian.'/1'); ?>';
		}
	}, 1000);
</script>
