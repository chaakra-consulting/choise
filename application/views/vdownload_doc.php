...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<!--<h3 class="page-header">Abaikan untuk Peserta PT.PMLI</h3>-->
		</div>
	...
	<div class="col-sm-12" style="background-color: #fff; padding-top: 20px; padding-bottom: 20px; padding-right: 10px; padding-left: 10px; margin-bottom: 20px; border-radius: 5px;">
		...
		<div class="form-group col-sm-12">
			...
			if (in_array('7', $data)) {
				...
				<p>3. <a href="<?php echo base_url('upload/dokumen/Informed Consent.pdf') ?>" download="Informed Consent.pdf">Informed Consent</a></p>

				<p>4. <a href="<?php echo base_url('upload/dokumen/PHYSICAL APPEARANCE FORM.pdf') ?>" download="PHYSICAL APPEARANCE FORM.pdf">Physical Appearance</a></p></br>
				<hr />
			<?php }
			if (in_array('3', $datamotlet)) {
				$cek = 1; ?>

				<b style="color: red">"UNTUK TALENT TES / TES TPA"</b><br><br>

				<b>Kelengkapan berkas yang wajib diunduh:</b><br><br>

				<p>1. <a href="<?php echo base_url('upload/dokumen/SELF_ASSESSMENT_TALENT_TEST.docx') ?>" download="SELF_ASSESSMENT_TALENT_TEST.doc">Self Assesment & Biodata</a></p></br>
				<hr />
			<?php }
			...
			if (in_array('17', $data)) {
				$cek = 1; ?>
				<b style="color: red">"UNTUK PELAMAR PT. SKTM"</b><br><br>

				<b>Kelengkapan berkas yang wajib diunduh:</b><br><br>

				<!-- <p>1. <a href="<?php echo base_url('upload/dokumen/ESAI KOMPETENSI.docx') ?>" download="ESAI KOMPETENSI.docx">Essay Kompetensi</a></p> -->

				<p>1. <a href="<?php echo base_url('upload/dokumen/ESAI KOMPETENSI SKTM.docx') ?>" download="ESAI KOMPETENSI SKTM.docx">Essay Kompetensi</a></p>


				<p>2. <a href="<?php echo base_url('upload/dokumen/SELF_ASSESSMENT&BIODATA PT SKTM.pdf') ?>" download="SELF_ASSESSMENT&BIODATA PT SKTM.pdf">Self Assesment & Biodata</a></p>

				<p>3. <a href="<?php echo base_url('upload/dokumen/Informed Consent.pdf') ?>" download="Informed Consent.pdf">Informed Consent</a></p></br>

			<?php }
			if (in_array('1', $data) || in_array('2', $data) || in_array('4', $data) || in_array('5', $data) || in_array('11', $data) || in_array('12', $data) || in_array('17', $data)) {
				$cek = 1; ?>
				<b style="color: red">"UNTUK PELAMAR UMUM"</b><br><br>
