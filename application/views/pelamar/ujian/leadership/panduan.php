...
<div class="col-sm-12 main">
	...
	<div class="row">
		...
		<div class="col-lg-9">
			...
			<h3>PETUNJUK INVENTORY LEADERSHIP</h3>
...
<div class="col-sm-12" style="background-color: #f9243f; padding: 30px; border-radius: 5px; margin-bottom: 20px;">
	...
	<h4 style="color: #fff;"><b>Petunjuk Pengerjaan Inventory Leadership</b></h4>

	<p style="color: #fff;">Dalam ujian ini terdapat 22 pasang pernyataan. Anda harus memilih salah satu dari setiap pasang pernyataan, yang menurut anda paling mencerminkan diri anda atau paling menunjukkan bagaimana perasaan anda. Kadang-kadang anda akan mendapatkan sepasang pernyataan yang keduanya tidak menggambarkan diri anda, dalam hal seperti ini anda <strong>tetap harus memilih salah satu yang lebih mendekati</strong></p><br>

	<p style="color: #fff;">Sebagai contoh, bila anda merasa pernyataan benar jawablah <strong>"Ya"</strong> apabila pernyataan salah jawablah <strong>"Tidak"</strong></p><br>
