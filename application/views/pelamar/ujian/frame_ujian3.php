...
<div class="col-sm-12 box">
	...
	<div class="col-md-7 col-sm-12" style="margin-bottom: 5px;">
		<form method="post">
			<div class="col-sm-12">
				<img src="<?php echo ($soal_subtes3->soal != '' ? base_url('./upload/bank_soal/cfit/' . $soal_subtes3->soal) : base_url('./upload/bank_soal/img_default.jpg')); ?>" class="img-responsive" alt="" style="width: 300px; margin: 10px; border-radius: 5px; border-radius: 5px">
	...
	<?php $this->load->view('pelamar/ujian/panel_ujian_3'); ?>
</div>
