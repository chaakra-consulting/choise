...
<style>
    ...
    .custom-radio-card input[type="checkbox"]:checked+.card-content .choice-text {
...
<div class="col-sm-12 main">
    <div class="row" style="margin-bottom: 10px; z-index: 1; display: flex; align-items: center;">
        <div class="col-xs-6 col-lg-6">
            <h3 class="exam-header-title">TIKI Sub 4</h3>
        </div>
                ...
                <form id="form-ujian" method="post">
                    ...
                    <div class="options-container">
                        <div class="custom-radio-card">
                            <input type="checkbox" id="optionA" name="jawaban[]" value="A">
                        ...
                        <div class="custom-radio-card">
                            <input type="checkbox" id="optionB" name="jawaban[]" value="B">
                        ...
                        <div class="custom-radio-card">
                            <input type="checkbox" id="optionC" name="jawaban[]" value="C">
                        ...
                        <div class="custom-radio-card">
                            <input type="checkbox" id="optionD" name="jawaban[]" value="D">
    ...
    $(document).ready(function() {
        ...
        window.loadQuestion = function(nomor) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if ( res.jawaban != 'null') {
                        let saved = res.jawaban;
                        $(`input[value="${saved.trim().toUpperCase()}"]`).prop('checked', true);
                    }
                    if (res.jawaban2 != 'null') {
                        let saved = res.jawaban2;
                        $(`input[value="${saved.trim().toUpperCase()}"]`).prop('checked', true);
                    }
                }
            });
        ...
        $('#btn-next').click(function() {
            if (currentSoal < totalSoal) {
                ...
                if (konfirmasi) {
                    window.location.href = '<?php echo base_url("Pelamar/Daftar_ujian/Tiki_d/latihan5"); ?>';
                }
            }
        });
