...
<div class="col-sm-12 main">
   <div class="row" style="margin-bottom: 10px; z-index: 1; display: flex; align-items: center;">
        <div class="col-md-8 col-sm-12">
            <h3>Kunci Jawaban Latihan Sub Tes 2</h3>
        </div>
        ...
        <div class="col-md-8 col-md-offset-2 col-sm-12">
            <div style="background-color: #fff; padding: 30px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
                ...
                <div class="text-center">
                    ...
                    <a href="<?php echo base_url('Pelamar/Daftar_ujian/Tiki_d/ujian2'); ?>" class="btn btn-primary btn-lg" style="padding: 12px 50px; border-radius: 25px; font-size: 16px; font-weight: bold; box-shadow: 0 4px 6px rgba(76, 175, 80, 0.3);">
                        Mulai Tes
                    </a>
                </div>
...
<script type="text/javascript">
    ...
    var x = setInterval(function() {
        ...
        if (distance < 0) {
            ...
            window.location.href = '<?php echo base_url('Pelamar/Daftar_ujian/Tiki_d/ujian2'); ?>'; 
        }
    }, 1000);
</script>
