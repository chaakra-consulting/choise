    ...
    <div class="row">
        <div class="col-md-6 col-sm-12" style="margin-bottom: 20px;">
            <div style="background-color: #f9243f; padding: 25px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); height: 100%;">
                ...
                <div style="background-color: #fff; padding: 15px; border-radius: 6px; text-align: center; margin-bottom: 15px;">
                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-1/instruksi.png'); ?>" alt="Contoh Instruksi" style="max-width: 100%; height: auto;">
        ...
        <div class="col-md-6 col-sm-12">
            <div style="background-color: #fff; padding: 25px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); height: 100%;">
                ...
                $end_lat_sub2 = ""; // fallback
                foreach ($ujian->result() as $key ) {
                    $end_lat_sub2 = $key->end_lat_sub2;
                }
                ?>

                <form method="post" action="<?php echo base_url('Pelamar/Daftar_ujian/Tiki_d/latihan2_answer') ?>">
                    
                    <div class="form-group">
                        <label style="font-size: 16px; font-weight: bold; color: #333;">1) Perhatikan gambar berikut:</label>
                        
                        <div class="question-image-wrapper">
                            <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-1/soal.png'); ?>" alt="Soal Latihan 1">
                        </div>
                        ...
                        <div class="options-container">
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-1/a.png'); ?>" alt="Opsi A" class="option-image">
                                </div>
                            </label>
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-1/b.png'); ?>" alt="Opsi B" class="option-image">
                                </div>
                            </label>
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-1/c.png'); ?>" alt="Opsi C" class="option-image">
                                </div>
                            </label>
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-1/d.png'); ?>" alt="Opsi D" class="option-image">
                                </div>
                            </label>
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-1/e.png'); ?>" alt="Opsi E" class="option-image">
                                </div>
                            </label>
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-1/f.png'); ?>" alt="Opsi F" class="option-image">
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-bottom: 30px;">
                        ...
                        <div class="question-image-wrapper">
                            <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-2/soal.png'); ?>" alt="Soal Latihan 2">
                        </div>
                        ...
                        <div class="options-container">
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    <span class="choice-letter">a</span>
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-2/a.png'); ?>" alt="Opsi A" class="option-image">
                                </div>
                            </label>
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    <span class="choice-letter">b</span>
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-2/b.png'); ?>" alt="Opsi B" class="option-image">
                                </div>
                            </label>
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    <span class="choice-letter">c</span>
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-2/c.png'); ?>" alt="Opsi C" class="option-image">
                                </div>
                            </label>
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    <span class="choice-letter">d</span>
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-2/d.png'); ?>" alt="Opsi D" class="option-image">
                                </div>
                            </label>
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    <span class="choice-letter">e</span>
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-2/e.png'); ?>" alt="Opsi E" class="option-image">
                                </div>
                            </label>
                            <label class="custom-radio-card">
                                ...
                                <div class="card-content">
                                    <span class="choice-letter">f</span>
                                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes2/contoh-2/f.png'); ?>" alt="Opsi F" class="option-image">
                                </div>
                            </label>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Timer Logic
        var endLatSub2 = "<?php echo !empty($end_lat_sub2) ? $end_lat_sub2 : date('Y-m-d H:i:s', strtotime('+5 minutes')); ?>";
        ...
        var x = setInterval(function() {
            ...
            if (distance < 0) {
                ...
                window.location.href = '<?php echo base_url('Pelamar/Daftar_ujian/Tiki_d/latihan2_answer'); ?>'; 
            }
        }, 1000);
    });
</script>