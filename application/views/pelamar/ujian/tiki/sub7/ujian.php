...
<div class="col-sm-12 main">
    <div class="row" style="margin-bottom: 10px; z-index: 1; display: flex; align-items: center;">
        <div class="col-xs-6 col-lg-6">
            <h3 class="exam-header-title">TIKI Sub 7</h3>
        </div>
    ...
    <div class="col-sm-12 modern-card">
        <div class="row">
            ...
            <div class="col-md-8 col-sm-12 left-panel">
                ...
                <div style="display: grid; grid-template-columns: repeat(10, 1fr); background-color: #ccc; border: 1px solid #ccc; margin-bottom: 25px; color: #000; font-weight: bold; text-align: center; border-radius: 4px; gap: 1px; font-size: 14px;">
                ...
                <form id="form-ujian" method="post">
                    ...
                    <div class="options-container" style="justify-content: flex-start; gap: 15px;">
                        <div class="custom-radio-card" style="flex: 0 1 calc(50% - 15px); min-width: 100px;">
                            <input type="radio" id="optionB" name="jawaban" value="A">
                            <label for="optionB" class="card-content">
                                <span class="choice-text" style="margin-left: 0;">Benar</span>
                            </label>
                        </div>
                        <div class="custom-radio-card" style="flex: 0 1 calc(50% - 15px); min-width: 100px;">
                            <input type="radio" id="optionS" name="jawaban" value="B">
                            <label for="optionS" class="card-content">
                                <span class="choice-text" style="margin-left: 0;">Salah</span>
                            </label>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        ...
        $('#btn-next').click(function() {
            if (currentSoal < totalSoal) {
                ...
                if (konfirmasi) {
                    window.location.href = '<?php echo base_url("Pelamar/Daftar_ujian/Tiki_d/latihan8"); ?>';
                }
            }
        });
