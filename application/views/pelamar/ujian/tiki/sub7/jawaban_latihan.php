...
<div class="col-sm-12 main">
     <div class="row" style="margin-bottom: 10px; z-index: 1; display: flex; align-items: center;">
        <div class="col-md-8 col-sm-12">
            <h3>Jawaban Latihan Sub Tes 7</h3>
        </div>
            ...
            <div style="background-color: #fff; padding: 30px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
                ...
                <div class="form-group" style="background-color: #fafafa; padding: 20px; border-radius: 8px; border: 1px solid #eee;">
                    <label style="font-size: 16px; font-weight: bold; color: #333;">
                        1) B x D = H <span class="correct-badge">Jawaban: Benar</span>
                    </label>
                ...
                <div class="form-group" style="background-color: #fafafa; padding: 20px; border-radius: 8px; border: 1px solid #eee; margin-bottom: 30px;">
                    <label style="font-size: 16px; font-weight: bold; color: #333;">
                        2) C x E = AF <span class="correct-badge">Jawaban: Salah</span>
                    </label>
                    <div class="options-container" style="justify-content: flex-start; gap: 15px;">
                        <label class="custom-radio-card" style="flex: 0 1 calc(50% - 15px); min-width: 100px;">
                            <input type="radio" disabled>
                ...
                <div class="text-center">
                    ...
                    <a href="<?php echo base_url('Pelamar/Daftar_ujian/Tiki_d/ujian7'); ?>" class="btn btn-primary btn-lg" style="padding: 12px 50px; border-radius: 25px; font-size: 16px; font-weight: bold; box-shadow: 0 4px 6px rgba(76, 175, 80, 0.3);">
                        Mulai Tes
                    </a>
                </div>
