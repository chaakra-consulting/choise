        ...
        <div class="col-md-6 col-sm-12" style="margin-bottom: 20px;">
            <div style="background-color: #f9243f; padding: 25px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); height: 100%;">
                ...
                <p style="color: #fff; text-align: justify; font-size: 14px; line-height: 1.6;">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error natus optio velit, quos ipsam vel voluptatibus assumenda non magnam voluptate! Deleniti ab sequi accusantium pariatur hic optio perferendis, illo consectetur. <b>A, B, C, D</b> dan <b>E</b>. 
                    <br><br>
                ...
                <div style="background-color: #fff; padding: 15px; border-radius: 6px; text-align: center; margin-bottom: 15px;">
                    <img src="<?php echo base_url('upload/bank_soal/tiki_d/subtes3/contoh-1/instruksi.png'); ?>" alt="Contoh Instruksi" style="max-width: 100%; height: auto;">
        ...
        <div class="col-md-6 col-sm-12">
            <div style="background-color: #fff; padding: 25px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); height: 100%;">
                <p style="font-size: 14px; color: #555; text-align: justify; margin-bottom: 20px;">
                    Coba pecahkan sendiri contoh-contoh di bawah ini, dan pilihlah <b>1(satu) gambar</b> yang sesuai dengan jawaban yang benar. Apapun jawaban Anda pada tahap latihan ini tidak akan dihitung poinnya.
                </p>
                
                <?php 
                $id_pelamar = $this->session->userdata('ses_id');
                $ujian = $this->db->query("SELECT * FROM tb_ujian_tiki_d WHERE id_ujian = 1");
                $end_lat_sub3 = ""; // fallback
                foreach ($ujian->result() as $key ) {
                    $end_lat_sub3 = $key->end_lat_sub3;
                }
                ?>

                <form method="post" action="<?php echo base_url('Pelamar/Daftar_ujian/Tiki_d/latihan3_answer') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="options-container">
                            <label class="custom-radio-card">
                                <input type="radio" name="jawaban_latihan1" value="a">
                    ...
                    <div class="form-group" style="margin-bottom: 30px;">
                        ...
                        <div class="options-container">
                            <label class="custom-radio-card">
                                <input type="radio" name="jawaban_latihan2" value="a">
                                <div class="card-content">
                                    <span class="choice-letter">a</span>
