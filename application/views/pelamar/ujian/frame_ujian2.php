...
<div class="col-sm-12 box">
	<div class="col-sm-12">
		<h4><b>Subtes <?php echo $soal_subtes2->subtes; ?></b><b>&nbsp; hanya dapat memilih 2 jawaban, jika terdapat kesalahan silahkan unchek</b></h4>
		...
		<form method="post">
			<div class="col-sm-12" style="padding-top: 4%">
				<div class="form-check col-sm-2 text-center" style="margin-top: 5px;">
					...
					<center>
						<img src="<?php echo ($soal_subtes2->opsi_a != '' ? base_url('./upload/bank_soal/cfit/' . $soal_subtes2->opsi_a) : base_url('./upload/bank_soal/img_default.jpg')); ?>" class="img-responsive" alt="" style="width: 100px; border-radius: 5px;">
					</center>
				</div>
				<div class="form-check col-sm-2 text-center" style="margin-top: 5px;">
					...
					<center>
						<img src="<?php echo ($soal_subtes2->opsi_b != '' ? base_url('./upload/bank_soal/cfit/' . $soal_subtes2->opsi_b) : base_url('./upload/bank_soal/img_default.jpg')); ?>" class="img-responsive" alt="" style="width: 100px; border-radius: 5px;">
					</center>
				</div>
				<div class="form-check col-sm-2 text-center" style="margin-top: 5px;">
					...
					<center>
						<img src="<?php echo ($soal_subtes2->opsi_c != '' ? base_url('./upload/bank_soal/cfit/' . $soal_subtes2->opsi_c) : base_url('./upload/bank_soal/img_default.jpg')); ?>" class="img-responsive" alt="" style="width: 100px; border-radius: 5px;">
					</center>
				</div>
				<div class="form-check col-sm-2 text-center" style="margin-top: 5px;">
					...
					<center>
						<img src="<?php echo ($soal_subtes2->opsi_d != '' ? base_url('./upload/bank_soal/cfit/' . $soal_subtes2->opsi_d) : base_url('./upload/bank_soal/img_default.jpg')); ?>" class="img-responsive" alt="" style="width: 100px; border-radius: 5px;">
					</center>
				</div>
				<div class="form-check col-sm-2 text-center" style="margin-top: 5px;">
					...
					<center>
						<img src="<?php echo ($soal_subtes2->opsi_e != '' ? base_url('./upload/bank_soal/cfit/' . $soal_subtes2->opsi_e) : base_url('./upload/bank_soal/img_default.jpg')); ?>" class="img-responsive" alt="" style="width: 100px; border-radius: 5px;">
					</center>
				</div>
			</div>
			<center>
