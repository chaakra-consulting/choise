...
$hitung = $this->db->query("SELECT * FROM tb_ujian_hitung WHERE id_ujian_hitung = ?", array($idHitung));
...
<div class="col-sm-12 main">
	...
	<div class="col-sm-12" style="background-color: #fff; padding: 30px; border-radius: 5px;">
		<div class="form-row">
			<form action="<?php echo base_url("Pelamar/Ujian/jawaban_hitung/") ?>" method="post">
				...
				<div class="form-group">
					...
					<textarea class="form-control" name="jawaban1a" required=required></textarea>
				</div>
				<br>
				...
				<div class="form-group">
					...
					<textarea class="form-control" name="jawaban1b" required=required></textarea>
				</div>
				<br>
				<div class="form-group">
					<label>c. Buatlan neraca saldo setelah penyesuaian</label>
					<textarea class="form-control" name="jawaban1c" required=required></textarea>
				</div>
				<br>
				<div class="form-group">
					<label>d. Buatlah laporan laba rugi 2018, laporan perubahan ekuitas 2018, dan neraca per 31 Desember 2018
					</label>
					<textarea class="form-control" name="jawaban1d" required=required></textarea>
				</div>
				<br>
				...
				<textarea class="form-control" name="jawaban2a" required=required></textarea>
				</div>
				<div class="form-group">
					<label>b. Buat jurnal pengakuan pendapatan dengan menggunakan metode persentase penyelesaian
					</label>
					<textarea class="form-control" name="jawaban2b" required=required></textarea>
				</div>
				<div class="form-group">
					<label>c. Hitung laba kotor</label>
					<textarea class="form-control" name="jawaban2c" required=required></textarea>
				</div>
				<div class="form-group">
					<br>
					...
					<textarea class="form-control" name="jawaban3a" required=required></textarea>
				</div>
				<br>
				<div class="form-group">
					...
					<textarea class="form-control" name="jawaban3b" required=required></textarea>
				</div>
			</div>
		</div>
