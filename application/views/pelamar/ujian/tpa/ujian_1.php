...
<div class="col-sm-12 main">
	...
	<div class="row" style="margin-bottom: -50px;">
		...
		<div class="col-lg-9">
			...
			<h3>TES POTENSI AKADEMIK SEKSI VERBAL</h3>
	...
	<iframe id="frame" src="<?php echo base_url('Pelamar/Ujian/frame_ujian_tpa1/' . $id_ujian . '/' . $nomor) ?>" width="100%" onload="this.style.height=this.contentDocument.body.scrollHeight +'px';" frameborder="0">Browser Anda Tidak Mendukung Iframe, Silahkan Perbaharui Browser Anda.</iframe>
...
<script type="text/javascript">
	...
	var x = setInterval(function() {
		...
		if (distance < 0) {
			...
			alert('Waktu Ujian TPA Verbal Telah Berakhir');
