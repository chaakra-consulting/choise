...
if($tpake=='1'){
?>  
<a href="<?php echo base_url('Pelamar/Ujian/start_ujian_tpa1/'.$id_pelamar.'/' . $idUjian) ?>" class="btn btn-primary mr-2 mb-2">Selanjutnya</a>
<?php 
}elseif($tpake=='2'){
?>
<a href="<?php echo base_url('Pelamar/Ujian/start_ujian_tpa2/'.$id_pelamar.'/' . $idUjian) ?>" class="btn btn-primary mr-2 mb-2">Selanjutnya</a>
<?php 
}else{
?>
<a href="<?php echo base_url('Pelamar/Ujian/start_ujian_tpa3/'.$id_pelamar.'/' . $idUjian) ?>" class="btn btn-primary mr-2 mb-2">Selanjutnya</a>
<?php 
}
?>
</div>
