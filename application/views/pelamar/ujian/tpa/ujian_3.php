...
<div class="col-sm-12 main">
	...
	<div class="row" style="margin-bottom: -50px;">
		...
		<div class="col-lg-9">
			...
			<h3>TES POTENSI AKADEMIK SEKSI PENALARAN</h3>
	...
	$dbwaktu = 'tb_ujian_tpa_penalaran';
	...
	<iframe id="frame" src="<?php echo base_url('Pelamar/Ujian/frame_ujian_tpa3/' . $id_ujian . '/' . $nomor) ?>" width="100%" onload="this.style.height=this.contentDocument.body.scrollHeight +'px';" frameborder="0">Browser Anda Tidak Mendukung Iframe, Silahkan Perbaharui Browser Anda.</iframe>
