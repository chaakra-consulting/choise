	...
	<div class="col-md-7 col-sm-12" style="margin-bottom: 5px;">
		<div class="col-sm-12">
			<form method="post">
				...
				<div class="form-check col-sm-2 text-center" style="margin-top: 5px;">
					<label class="form-check-label" for="ist120"></label>
					<!-- <input class="form-check-input" type="checkbox"  <?php if (!empty($jawaban5->jawaban) && $jawaban5->jawaban == "7") { ?> checked="checked" <?php } ?> name="jawaban" value="7"> -->
				...
				<div class="form-check col-sm-2 text-center" style="margin-top: 5px;">
					...
					<input class="form-check-input" type="checkbox" <?php if (!empty($jawaban5->jawaban) && $jawaban5->jawaban == "0" || !empty($jawaban5->jawaban2) && $jawaban5->jawaban2 == "0" || !empty($jawaban5->jawaban3) && $jawaban5->jawaban3 == "0") { ?> checked="checked" <?php } ?> name="jawaban1[]" value="0">
					<center>
