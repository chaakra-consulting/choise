...
<div class="col-sm-12 box">
		...
		<form method="post">
			...
			<center>
				...
				<div class="baten">
					...
					<?php } ?>
					<?php if ($soal_subtes9->nomor_soal >= 176 && $soal_subtes9->subtes == 9) { ?>
						<button type="submit" style="margin-top: 5%" class="btn btn-danger" formaction="<?php echo base_url('Pelamar/Ujian/masukkan_jawaban_ist_endSub9') ?>" class="btn btn-primary"> Selesai <i class="fa fa-arrow-circle-right"></i>
						</button>
					<?php } ?>
				</div>
			</center>
	...
	<?php $this->load->view('pelamar/ujian/ist/panel_ujian_ist9'); ?>
</div>
