...
<div class="col-sm-12 box">
      ...
      <div class="col-sm-12">
        ...
        <div class="form-check col-sm-2 text-center" style="margin-top: 5px;">
          ...
          <?php echo $soal_subtes4->opsi_a; ?>
            ...
            <br><input class="form-check-input" type="text" value="<?= isset($jawaban4->jawaban) ? $jawaban4->jawaban : "" ?>"name="jawaban" autocomplete="off" ></br>
  ...
  <?php $this->load->view('pelamar/ujian/ist/panel_ujian_ist4'); ?>
</div>
