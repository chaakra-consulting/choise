...
<form action="<?php echo base_url("Pelamar/Ujian/jawaban_holland/") ?>" method="post">
	<div class="col-sm-12 main">
		...
		<div class="col-sm-12" style="background-color: #f9243f; padding: 30px; border-radius: 5px; margin-bottom: 20px;">
			...
			<p style="color: #fff">Dilarang untuk melakukan refresh pada saat ujian berlangsung, karena akan menghilangkan jawaban</p>
		</div>
		<label style="color:red">*Dimohon untuk me submit jawaban sebelum waktu ujian berakhir, agar jawaban dapat terekam !</label></br>
