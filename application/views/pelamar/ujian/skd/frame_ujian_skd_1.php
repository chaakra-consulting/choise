...
<div class="col-sm-12 box">
	<div class="col-sm-6">
		<h4><b>Subtes <?php echo $soal_subtes1->subtes; ?> - <?php echo $soal_subtes1->jenis_soal; ?></b></h4>
	...
	<div class="col-md-7 col-sm-12" style="margin-bottom: 5px;">
		<div class="col-sm-12">
			...
			<h5><b>Soal Nomor <?php echo $soal_subtes1->nomor_soal ?></b></h5>
		...
		<center>
			...
			<input type="hidden" name="jenis_soal" value="<?php echo $soal_subtes1->jenis_soal ?>">
			<div class="baten">
				<?php if ($soal_subtes1->nomor_soal != 1 && $soal_subtes1->subtes == 1) { ?>
					<button type="submit" style="margin-top: 5%" class="btn btn-primary" formaction="<?php echo base_url('Pelamar/Ujian/masukkan_jawaban_skd1/1') ?>"> <i class="fa fa-arrow-circle-left"> </i> Sebelumnya
					</button>
				<?php } ?>
				<!-- <button type="submit" class="btn btn-primary" formaction="<?php echo base_url('Pelamar/Ujian/masukkan_jawaban_skd1/0') ?>"> Konfirmasi -->
				</button>
				<?php if ($soal_subtes1->nomor_soal != 25 && $soal_subtes1->subtes == 1) { ?>
					<button type="submit" style="margin-top: 5%" class="btn btn-primary" formaction="<?php echo base_url('Pelamar/Ujian/masukkan_jawaban_skd1/2') ?>"> Selanjutnya <i class="fa fa-arrow-circle-right"></i>
					</button>
				<?php } ?>
				<?php if ($soal_subtes1->nomor_soal >= 25 && $soal_subtes1->subtes == 1) { ?>
					<button type="submit" style="margin-top: 5%" class="btn btn-info" formaction="<?php echo base_url('Pelamar/Ujian/masukkan_jawaban_skd_endSub1') ?>" class="btn btn-primary"> Subtes 2 <i class="fa fa-arrow-circle-right"></i>
					</button>
				<?php } ?>
			</div>
		</center>
	...
	<?php
	$this->load->view('pelamar/ujian/skd/panel_ujian_1');
	?>
