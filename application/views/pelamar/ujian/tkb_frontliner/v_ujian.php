...
<div class="col-sm-12 main">
	...
	$dbwaktu = 'tb_ujian_tkb_frontlinerstaff';
	...
	<iframe id="frame" src="<?php echo base_url('Pelamar/Ujian/frame_ujian_tkb_frontliner/' . $id_ujian . '/' . $nomor) ?>" width="100%" onload="this.style.height=this.contentDocument.body.scrollHeight +'px';" frameborder="0">Browser Anda Tidak Mendukung Iframe, Silahkan Perbaharui Browser Anda.</iframe>
...
<script type="text/javascript">
	...
	var x = setInterval(function() {
		...
		if (distance < 0) {
			...
			alert('Waktu Ujian TKB Frontliner Staff Telah Berakhir');
