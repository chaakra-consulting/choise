...
<div class="col-sm-12 box">
	...
	<div class="col-md-7 col-sm-12" style="margin-bottom: 5px;">
		<form method="post">
			<div class="col-sm-12">
            <img src="<?php echo base_url("assets3/images/CFIT 2a/Tes 1/Soal $soal_subtes1->nomor_soal/soal-$soal_subtes1->nomor_soal.png") ?>" class="img-responsive" alt="Soal <?= $soal_subtes1->nomor_soal ?>" style="width: 300px; margin-bottom: 15px; border-radius: 5px;">
			<div class="options-container">
                <label class="custom-radio-card">
                    ...
                    <div class="card-content">
                        ...
                        <img src="<?php echo base_url("assets3/images/CFIT 2a/Tes 1/Soal $soal_subtes1->nomor_soal/a.png") ?>" alt="Option A">
                    </div>
                </label>
                ...
                <label class="custom-radio-card">
                    ...
                    <div class="card-content">
                        ...
                        <img src="<?php echo base_url("assets3/images/CFIT 2a/Tes 1/Soal $soal_subtes1->nomor_soal/b.png") ?>" alt="Option B">
                    </div>
                </label>
                ...
                <label class="custom-radio-card">
                    ...
                    <div class="card-content">
                        ...
                        <img src="<?php echo base_url("assets3/images/CFIT 2a/Tes 1/Soal $soal_subtes1->nomor_soal/c.png") ?>" alt="Option C">
                    </div>
                </label>
                ...
                <label class="custom-radio-card">
                    ...
                    <div class="card-content">
                        ...
                        <img src="<?php echo base_url("assets3/images/CFIT 2a/Tes 1/Soal $soal_subtes1->nomor_soal/d.png") ?>" alt="Option D">
                    </div>
                </label>
                ...
                <label class="custom-radio-card">
                    ...
                    <div class="card-content">
                        ...
                        <img src="<?php echo base_url("assets3/images/CFIT 2a/Tes 1/Soal $soal_subtes1->nomor_soal/e.png") ?>" alt="Option E">
                    </div>
                </label>
            </div>
			...
			<center>
				...
				<div class="baten">
					<?php if ($soal_subtes1->nomor_soal != 1 && $soal_subtes1->subtes == 1) { ?>
						<button type="submit" style="margin-top: 5%" class="btn btn-primary" formaction="<?php echo base_url('Pelamar/Ujian/masukkan_jawaban_cfit_2a_subtes_1/1') ?>"> <i class="fa fa-arrow-circle-left"> </i> Sebelumnya
						</button>
					<?php } ?>
					...
					<?php if ($soal_subtes1->nomor_soal != 12 && $soal_subtes1->subtes == 1) { ?>
						<button type="submit" style="margin-top: 5%" class="btn btn-primary" formaction="<?php echo base_url('Pelamar/Ujian/masukkan_jawaban_cfit_2a_subtes_1/2') ?>"> Selanjutnya <i class="fa fa-arrow-circle-right"></i>
						</button>
					<?php } ?>
					<?php if ($soal_subtes1->nomor_soal >= 12 && $soal_subtes1->subtes == 1) { ?>
						<button type="submit" style="margin-top: 5%" class="btn btn-primary" formaction="<?php echo base_url('Pelamar/Ujian/masukkan_jawaban_end_cfit_2a_subtes_1') ?>" class="btn btn-primary"> Subtes 2 <i class="fa fa-arrow-circle-right"></i>
						</button>
					<?php } ?>
				</div>
			</center>
	...
	<?php $this->load->view('pelamar/ujian/panel_ujian_cfit_2a_1'); ?>
</div>
