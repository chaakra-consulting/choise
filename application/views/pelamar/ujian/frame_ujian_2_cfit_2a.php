...
<div class="col-sm-12 box">
			...
			<div class="options-container">
                <label class="custom-radio-card">
                    ...
                    <div class="card-content">
                        ...
                        <img src="<?php echo base_url("assets3/images/CFIT 2a/Tes 2/Soal $soal_subtes2->nomor_soal/a.png") ?>" alt="Option A">
                    </div>
                </label>
                ...
                <label class="custom-radio-card">
                    ...
                    <div class="card-content">
                        ...
                        <img src="<?php echo base_url("assets3/images/CFIT 2a/Tes 2/Soal $soal_subtes2->nomor_soal/b.png") ?>" alt="Option B">
                    </div>
                </label>
                ...
                <label class="custom-radio-card">
                    ...
                    <div class="card-content">
                        ...
                        <img src="<?php echo base_url("assets3/images/CFIT 2a/Tes 2/Soal $soal_subtes2->nomor_soal/c.png") ?>" alt="Option C">
                    </div>
                </label>
                ...
                <label class="custom-radio-card">
                    ...
                    <div class="card-content">
                        ...
                        <img src="<?php echo base_url("assets3/images/CFIT 2a/Tes 2/Soal $soal_subtes2->nomor_soal/d.png") ?>" alt="Option D">
                    </div>
                </label>
                ...
                <label class="custom-radio-card">
                    ...
                    <div class="card-content">
                        ...
                        <img src="<?php echo base_url("assets3/images/CFIT 2a/Tes 2/Soal $soal_subtes2->nomor_soal/e.png") ?>" alt="Option E">
                    </div>
                </label>
            </div>
			...
			<center>
				...
				<div class="baten">
					<?php if ($soal_subtes2->nomor_soal != 1 && $soal_subtes2->subtes == 2) { ?>
						<button type="submit" style="margin-top: 5%" class="btn btn-primary" formaction="<?php echo base_url('Pelamar/Ujian/masukkan_jawaban_cfit_2a_subtes_2/1') ?>"> <i class="fa fa-arrow-circle-left"> </i> Sebelumnya
						</button>
					<?php } ?>
					...
					<?php if ($soal_subtes2->nomor_soal != 14 && $soal_subtes2->subtes == 2) { ?>
						<button type="submit" style="margin-top: 5%" class="btn btn-primary" formaction="<?php echo base_url('Pelamar/Ujian/masukkan_jawaban_cfit_2a_subtes_2/2') ?>"> Selanjutnya <i class="fa fa-arrow-circle-right"></i>
						</button>
					<?php } ?>
					<?php if ($soal_subtes2->nomor_soal >= 14 && $soal_subtes2->subtes == 2) { ?>
						<button type="submit" style="margin-top: 5%" class="btn btn-primary" formaction="<?php echo base_url('Pelamar/Ujian/masukkan_jawaban_end_cfit_2a_subtes_2') ?>" class="btn btn-primary"> Subtes 3 <i class="fa fa-arrow-circle-right"></i>
						</button>
					<?php } ?>
				</div>
			</center>
	...
	<?php $this->load->view('pelamar/ujian/panel_ujian_cfit_2a_2'); ?>
</div>
