...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Konfirmasi Ujian <?php echo ucfirst(str_replace('_', ' ', $exam_type)); ?></li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Konfirmasi Ujian <?php echo ucfirst(str_replace('_', ' ', $exam_type)); ?></h1>
        </div>
    </div>
    <div class="col-sm-12" style="background-color: #fff; padding-top: 10px; padding-bottom: 20px; padding-right: 10px; padding-left: 10px; margin-bottom: 20px; border-radius: 5px;">
        ...
        <div class="col-sm-12">
            <div class="col-sm-12" style="background-color: #f9243f; padding-top: 10px; padding-left: 20px; padding-right: 20px; border-radius: 5px;">
                ...
                <li style="color: #fff;">Pada setiap soal, terdapat daftar pekerjaan.</li>
                <li style="color: #fff;">Urutkan 3 pekerjaan yang paling Anda minati.</li>
                <li style="color: #fff;">Waktu pengerjaan: <?php echo $durasi; ?> menit.</li>
                <li style="color: #fff;">Jumlah soal: 12.</li>
            </div>
        </div>
