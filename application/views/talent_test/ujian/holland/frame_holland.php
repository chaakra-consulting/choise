...
$idHolland = $this->session->userdata('talent_test_id_ujian');
$end_time = date('Y-m-d H:i:s', $end_time);
?>

<form action="<?php echo site_url('talent-test/save-answer'); ?>" method="post">
    <input type="hidden" name="exam_type" value="holland">
    <input type="hidden" name="id_ujian" value="<?php echo $idHolland; ?>">
    <input type="hidden" name="id_pendaftar_pelatihan" value="<?php echo $user_id; ?>">
    <input type="hidden" name="redirect" value="6">
    ...
    <div class="col-sm-12 main">
        ...
        <div class="col-sm-12" style="background-color: #f9243f; padding: 30px; border-radius: 5px; margin-bottom: 20px;">
            ...
            <p style="color: #fff">Pada kuesioner ini terdiri atas 6 tabel, masing-masing tabel terdiri atas 3 kolom kosong yang harus diisi 
                dengan menggunakan tanda (<i class="fa fa-check"></i>) pada pernyataan yang mencerminkan diri Anda sekalian pada beberapa 
                pertanyaan yang telah disediakan. Untuk pemilihan masing-masing pernyataan sangat memungkinkan untuk memilih atau mencentang 
                (<i class="fa fa-check"></i>) lebih dari satu pernyataan pada masing-masing kolom. Oleh karena itu, kami mengharapkan Anda sekalian 
                mencermati dengan seksama setiap pernyataan yang ada, kemudian memilih satu atau lebih dari pernyataan pada masing-masing kolom yang 
                tersedia pada tabel tersebut.
            </p>
        </div>
        <label style="color: red">Dimohon untuk me submit jawaban sebelum waktu ujian berakhir, agar jawaban dapat terekam !</label>
        ...
        <div class="col-sm-12" style="background-color: #fff; padding: 30px; border-radius: 5px;">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><input type="checkbox" class="form-check-input" onclick="calc_r(this)" value="1"> Praktis</td>
                        <td><input type="checkbox" class="form-check-input2" onclick="calc_r(this)" value="1"> Memperbaiki alat elektronik</td>
                        <td><input type="checkbox" class="form-check-input" onclick="calc_r(this)" value="1"> Kegiatan yang menuntut untuk berpikir secara mekanis</td>
                    </tr>
					<tr>
					...
					<input id="result_input" type="hidden" name="nilai_r">
                </table>
                ...
                <table class="table table-bordered">
                    ...
                    <input type="hidden" name="nilai_i" id="hasil_i">
                </table>
                ...
                <table class="table able-bordered">
                    ...
                    <input type="hidden" name="nilai_a" id="hasil_a">
                </table>
                ...
                <table class="table table-bordered">
                    ...
                    <input type="hidden" name="nilai_s" id="hasil_s">
                </table>
                ...
                <table class="table table-bordered">
                    ...
                    <input type="hidden" name="nilai_e" id="hasil_e">
                </table>
                ...
                <table class="table table-bordered">
                    ...
                    <input type="hidden" name="nilai_k" id="hasil_k">
                </table>
            </div>
        </div>
    </div>
    <div class="col-sm-12 button-lm-little justify-content-center text-center" style="margin-top: 20px;">
        <input style="margin-bottom: 2%;" type="submit" value="Selesai" class="btn btn-primary mr-2 mb-2" onclick="return confirm('Aoakah Anda yakin ingin menyelesaikan ujian holland?');">
    </div>
</form>
...
<script type="text/javascript">
    ...
    var x = setInterval(function(){
        ...
        if (distance < 0) {
            clearInterval(x);
            alert('Waktu Ujian Holland Telah Berakhir');
