...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  <div class="col-sm-12" style="background-color: #fff; padding-top: 10px; padding-bottom: 20px; padding-right: 10px; padding-left: 10px; margin-bottom: 20px;">
    <div class="col-sm-12">
      ...
      <h4 style="color:red;">Kerjakan semua ujian kecuali yang dikhususkan!</h4>
      <hr color="black">
    </div>
...
<tr>
  <?php
  $cepat = $this->db->query("SELECT * FROM tb_ujian_cepat")->result_array();
  foreach ($cepat as $key_cepat) {
    if ($key_cepat['status'] == "aktif" && $tb_lowongan[0]->status == "tersedia" && $tb_apply[0]->status_lamaran == 'Diterima' && $tb_apply[0]->status_ujian == 'aktif') { ?>
      <td><?php echo $no++; ?></td>
      <td><?php echo $key_cepat['nama_ujian']; ?></td>
      <td><?php echo date('d F Y H:i:s', strtotime($key_cepat['waktu_mulai'])) ?> WIB</td>
      <td><?php echo date('d F Y H:i:s', strtotime($key_cepat['waktu_akhir'])) ?> WIB</td>
      <td>

        <?php
        date_default_timezone_set("Asia/Jakarta");
        if (date('d F Y H:i:s') < date('d F Y H:i:s', strtotime($key_cepat['waktu_mulai']))) {
          echo "belum dimulai";
        } elseif (date('d F Y H:i:s') >= date('d F Y H:i:s', strtotime($key_cepat['waktu_mulai'])) && date('d F Y H:i:s') <= date('d F Y H:i:s', strtotime($key_cepat['waktu_akhir']))) { ?>
          <a href="<?php echo base_url('Pelamar/Ujian/panduan_cepat/' . $id_pelamar . '/' . $key_cepat['id_ujian_cepat']) ?>" class="btn btn-primary">Kerjakan Sekarang</a>
        <?php } elseif (date('d F Y H:i:s') > date('d F Y H:i:s', strtotime($key_cepat['waktu_akhir']))) {
          echo "Ujian sudah berakhir";
        } ?>
      </td>
</tr>
...
<tr>
  <?php
  $tray = $this->db->query("SELECT * FROM tb_ujian_tray")->result_array();
  foreach ($tray as $key_tray) {
    if ($key_tray['status'] == "aktif" && $tb_lowongan[0]->status == "tersedia" && $tb_apply[0]->status_lamaran == 'Diterima' && $tb_apply[0]->status_ujian == 'aktif') { ?>
      <td><?php echo $no++; ?></td>
      <td><?php echo $key_tray['nama_ujian']; ?></td>
      <td><?php echo date('d F Y H:i:s', strtotime($key_tray['waktu_mulai'])) ?> WIB</td>
      <td><?php echo date('d F Y H:i:s', strtotime($key_tray['waktu_akhir'])) ?> WIB</td>
      <td>

        <?php
        date_default_timezone_set("Asia/Jakarta");
        if (date('d F Y H:i:s') < date('d F Y H:i:s', strtotime($key_tray['waktu_mulai']))) {
          echo "belum dimulai";
        } elseif (date('d F Y H:i:s') >= date('d F Y H:i:s', strtotime($key_tray['waktu_mulai'])) && date('d F Y H:i:s') <= date('d F Y H:i:s', strtotime($key_tray['waktu_akhir']))) { ?>
          <a href="<?php echo base_url('Pelamar/Ujian/panduan_tray/' . $id_pelamar . '/' . $key_tray['id_ujian_tray']) ?>" class="btn btn-primary">Kerjakan Sekarang</a>
        <?php } elseif (date('d F Y H:i:s') > date('d F Y H:i:s', strtotime($key_tray['waktu_akhir']))) {
          echo "Ujian sudah berakhir";
        } ?>
      </td>
</tr>
...
<tr>
  <?php
  foreach ($studi2 as $key_studi2) {
    if ($key_studi2['status'] == "aktif" && $tb_lowongan[0]->status == "tersedia" && $tb_apply[0]->status_lamaran == 'Diterima' && $tb_apply[0]->status_ujian == 'aktif') { ?>
      <td><?php echo $no++; ?></td>
      <td><?php echo $key_studi2['nama_ujian']; ?></td>
      <td><?php echo date('d F Y H:i:s', strtotime($key_studi2['waktu_mulai'])) ?> WIB</td>
      <td><?php echo date('d F Y H:i:s', strtotime($key_studi2['waktu_akhir'])) ?> WIB</td>
      <td>

        <?php
        date_default_timezone_set("Asia/Jakarta");
        if (date('d F Y H:i:s') < date('d F Y H:i:s', strtotime($key_studi2['waktu_mulai']))) {
          echo "belum dimulai";
        } elseif (date('d F Y H:i:s') >= date('d F Y H:i:s', strtotime($key_studi2['waktu_mulai'])) && date('d F Y H:i:s') <= date('d F Y H:i:s', strtotime($key_studi2['waktu_akhir']))) { ?>
          <a href="<?php echo base_url('Pelamar/Ujian/ujian_studi2/' . $id_pelamar . '/' . $key_studi2['id_ujian_studi2']) ?>"
            class="btn btn-primary">Kerjakan Sekarang</a>
        <?php } elseif (date('d F Y H:i:s') > date('d F Y H:i:s', strtotime($key_studi2['waktu_akhir']))) {
          echo "Ujian sudah berakhir";
        } ?>
      </td>
</tr>
    ...
    if ($key_studi_ldg['status'] == "aktif" && $tb_lowongan[0]->status == "tersedia" && $tb_apply[0]->status_lamaran == 'Diterima' && $tb_apply[0]->status_ujian == 'aktif') { ?>
      ...
      <td>
        ...
        if (date('d F Y H:i:s') < date('d F Y H:i:s', strtotime($key_studi_ldg['waktu_mulai']))) {
          ...
          <a href="<?php echo base_url('Pelamar/Ujian/ujian_studi_ldg/' . $id_pelamar . '/' . $key_studi['id_ujian_studi_ldg']) ?>" class="btn btn-primary">Kerjakan Sekarang</a>
...
<tr>
  <?php
  $tkp = $this->db->query("SELECT * FROM tb_ujian_tkp")->result_array();
  foreach ($tkp as $key_tkp) {
    if ($key_tkp['status'] == "aktif" && $tb_lowongan[0]->status == "tersedia" && $tb_apply[0]->status_lamaran == 'Diterima' && $tb_apply[0]->status_ujian == 'aktif') { ?>
      <td><?php echo $no++; ?></td>
      <td><?php echo $key_tkp['nama_ujian']; ?></td>
      <td><?php echo date('d F Y H:i:s', strtotime($key_tkp['waktu_mulai'])) ?> WIB</td>
      <td><?php echo date('d F Y H:i:s', strtotime($key_tkp['waktu_akhir'])) ?> WIB</td>
      <td>
        <?php
        date_default_timezone_set("Asia/Jakarta");
        if (date('d F Y H:i:s') < date('d F Y H:i:s', strtotime($key_tkp['waktu_mulai']))) {
          echo "belum dimulai";
        } elseif (date('d F Y H:i:s') >= date('d F Y H:i:s', strtotime($key_tkp['waktu_mulai'])) && date('d F Y H:i:s') <= date('d F Y H:i:s', strtotime($key_tkp['waktu_akhir']))) { ?>
          <a href="<?php echo base_url('Pelamar/Ujian/panduan_tkp/' . $id_pelamar . '/' . $key_tkp['id_ujian_tkp']) ?>" class="btn btn-primary">Kerjakan Sekarang</a>
        <?php } elseif (date('d F Y H:i:s') > date('d F Y H:i:s', strtotime($key_tkp['waktu_akhir']))) {
          echo "Ujian sudah berakhir";
        } ?>
      </td>
</tr>
...
<tr>
  <?php
  $army = $this->db->query("SELECT * FROM tb_ujian_army")->result_array();
  foreach ($army as $key_army) {
    if ($key_army['status'] == "aktif" && $tb_lowongan[0]->status == "tersedia" && $tb_apply[0]->status_lamaran == 'Diterima' && $tb_apply[0]->status_ujian == 'aktif') { ?>
      <td><?php echo $no++; ?></td>
      <td><?php echo $key_army['nama_ujian']; ?></td>
      <td><?php echo date('d F Y H:i:s', strtotime($key_army['waktu_mulai'])) ?> WIB</td>
      <td><?php echo date('d F Y H:i:s', strtotime($key_army['waktu_akhir'])) ?> WIB</td>
      <td>

        <?php
        date_default_timezone_set("Asia/Jakarta");
        if (date('d F Y H:i:s') < date('d F Y H:i:s', strtotime($key_army['waktu_mulai']))) {
          echo "belum dimulai";
        } elseif (date('d F Y H:i:s') >= date('d F Y H:i:s', strtotime($key_army['waktu_mulai'])) && date('d F Y H:i:s') <= date('d F Y H:i:s', strtotime($key_army['waktu_akhir']))) { ?>
          <a href="<?php echo base_url('Pelamar/Ujian/panduan_army/' . $id_pelamar . '/' . $key_army['id_ujian_army']) ?>" class="btn btn-primary">Kerjakan Sekarang</a>
        <?php } elseif (date('d F Y H:i:s') > date('d F Y H:i:s', strtotime($key_army['waktu_akhir']))) {
          echo "Ujian sudah berakhir";
        } ?>
      </td>
</tr>
...
<tr>
  <?php
  $tpa = $this->db->query("SELECT * FROM tb_ujian_tpa_verbal2")->result_array();
  foreach ($tpa as $key_tpa) {
    if ($key_tpa['status'] == "aktif" && $tb_lowongan[0]->status == "tersedia" && $tb_apply[0]->status_lamaran == 'Diterima' && $tb_apply[0]->status_ujian == 'aktif') { ?>
      <td><?php echo $no++; ?></td>
      <td><?php echo $key_tpa['nama_ujian']; ?></td>
      ...
      <td>
        ...
        if (date('d F Y H:i:s') < date('d F Y H:i:s', strtotime($key_tpa['waktu_mulai']))) {
          ...
          <a href="<?php echo base_url('Pelamar/Ujian/panduan_tpa2_1/' . $id_pelamar . '/' . $key_tpa['id_ujian']) ?>" class="btn btn-primary">Kerjakan Sekarang</a>
        <?php } elseif (date('d F Y H:i:s') > date('d F Y H:i:s', strtotime($key_tpa['waktu_akhir']))) {
          echo "Ujian sudah berakhir";
        } ?>
      </td>
...
<tr>
  <?php
  $tpa = $this->db->query("SELECT * FROM tb_ujian_tpa_kuantitatif2")->result_array();
  foreach ($tpa as $key_tpa) {
    if ($key_tpa['status'] == "aktif" && $tb_lowongan[0]->status == "tersedia" && $tb_apply[0]->status_lamaran == 'Diterima' && $tb_apply[0]->status_ujian == 'aktif') { ?>
      <td><?php echo $no++; ?></td>
      <td><?php echo $key_tpa['nama_ujian']; ?></td>
      ...
      <td>
        ...
        if (date('d F Y H:i:s') < date('d F Y H:i:s', strtotime($key_tpa['waktu_mulai']))) {
          ...
          <a href="<?php echo base_url('Pelamar/Ujian/panduan_tpa2_2/' . $id_pelamar . '/' . $key_tpa['id_ujian']) ?>" class="btn btn-primary">Kerjakan Sekarang</a>
        <?php } elseif (date('d F Y H:i:s') > date('d F Y H:i:s', strtotime($key_tpa['waktu_akhir']))) {
          echo "Ujian sudah berakhir";
        } ?>
      </td>
...
<tr>
  <?php
  $tpa = $this->db->query("SELECT * FROM tb_ujian_tpa_penalaran2")->result_array();
  foreach ($tpa as $key_tpa) {
    if ($key_tpa['status'] == "aktif" && $tb_lowongan[0]->status == "tersedia" && $tb_apply[0]->status_lamaran == 'Diterima' && $tb_apply[0]->status_ujian == 'aktif') { ?>
      <td><?php echo $no++; ?></td>
      <td><?php echo $key_tpa['nama_ujian']; ?></td>
      ...
      <td>
        ...
        if (date('d F Y H:i:s') < date('d F Y H:i:s', strtotime($key_tpa['waktu_mulai']))) {
          ...
          <a href="<?php echo base_url('Pelamar/Ujian/panduan_tpa2_3/' . $id_pelamar . '/' . $key_tpa['id_ujian']) ?>" class="btn btn-primary">Kerjakan Sekarang</a>
        <?php } elseif (date('d F Y H:i:s') > date('d F Y H:i:s', strtotime($key_tpa['waktu_akhir']))) {
          echo "Ujian sudah berakhir";
        } ?>
      </td>
...
<tr>
  <?php
  $tpa = $this->db->query("SELECT * FROM tb_ujian_paps_ugm")->result_array();
  foreach ($tpa as $key_tpa) {
    if ($key_tpa['status'] == "aktif" && $tb_lowongan[0]->status == "tersedia" && $tb_apply[0]->status_lamaran == 'Diterima' && $tb_apply[0]->status_ujian == 'aktif') { ?>
      <td><?php echo $no++; ?></td>
      <td><?php echo $key_tpa['nama_ujian']; ?></td>
      ...
      <td>
        ...
        if (date('d F Y H:i:s') < date('d F Y H:i:s', strtotime($key_tpa['waktu_mulai']))) {
          ...
          <a href="<?php echo base_url('Pelamar/Daftar_ujian/Tes_paps_ugm/') ?>" class="btn btn-primary">Kerjakan Sekarang</a>
        <?php } elseif (date('d F Y H:i:s') > date('d F Y H:i:s', strtotime($key_tpa['waktu_akhir']))) {
          echo "Ujian sudah berakhir";
        } ?>
      </td>
