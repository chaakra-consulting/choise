...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="col-sm-12" style="background-color: #fff; padding-top: 10px; padding-bottom: 20px; padding-right: 10px; padding-left: 10px; margin-bottom: 20px; border-radius: 5px;">
		...
		foreach ($ist as $key_ist) {
			...
			$lowongan = $this->db->query("SELECT * FROM tb_apply WHERE id_pelamar = ? AND id_lowongan = ?", array($id_pelamar, $id_lowongan));
			$jabatan = $this->db->query("SELECT * FROM tb_lowongan WHERE id_lowongan = ?", array($id_lowongan));
