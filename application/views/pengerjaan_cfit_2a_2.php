...
<div class="col-sm-12 main">
	...
	<iframe id="frame" src="<?php echo base_url('Pelamar/Ujian/frame_ujian_cfit_2a_subtes_2/'.$id_ujian.'/'.$nomor ) ?>" width="100%" onload="this.style.height=this.contentDocument.body.scrollHeight +'px';"  frameborder="0">Browser Anda Tidak Mendukung  Iframe, Silahkan Perbaharui Browser Anda.</iframe>
</div>
