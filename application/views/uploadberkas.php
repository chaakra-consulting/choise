...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="col-sm-12" style="background-color: #fff; padding-top: 20px; padding-bottom: 20px; padding-right: 10px; padding-left: 10px; margin-bottom: 20px; border-radius: 5px;">
		...
		<div class="form-group col-sm-12">
			...
			<b style="color: red">1. Pastikan Anda Sudah Mengisi Data Diri.</b><br>
			<b style="color: red">2. Patikan dalam penulisan Nama Lengkap di Data Diri tidak ada tanda "." (titik) "," (koma).</b><br>
			<b style="color: red">3. Khusus peserta Talent Test / Test TPA hanya mengupload pada bagian no.7 (dokumen self assesment).</b><br><br>
