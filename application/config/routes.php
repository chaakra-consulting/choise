...
$route['administrator/kupon-talent-test/']                              = 'Administrator/KuponTalentTest';
$route['administrator/kupon-talent-test/create']                        = 'Administrator/KuponTalentTest/create';
$route['administrator/kupon-talent-test/edit/(:num)']                   = 'Administrator/KuponTalentTest/edit/$1';
$route['administrator/kupon-talent-test/delete/(:num)']                 = 'Administrator/KuponTalentTest/delete/$1';
