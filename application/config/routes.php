...
$route['administrator/quiz']                                            = 'AdminQuiz/index';
$route['administrator/quiz/add']                                             = 'AdminQuiz/add';
$route['administrator/quiz/edit/(:num)']                                     = 'AdminQuiz/edit/$1';
$route['administrator/quiz/delete/(:num)']                                   = 'AdminQuiz/delete/$1';
$route['public/holland-quiz']                                           = 'Quiz/holland_quiz';
$route['public/submit_form']                                            = 'Quiz/submit_form';
$route['public/result']                                                 = 'Quiz/result';
$route['public']                                                        = 'Quiz/landing';