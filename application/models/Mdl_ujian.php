...
class Mdl_ujian extends CI_Model
{
	...
	public function get_skd_subtes_6($rdr)
	{
		$query = $this->db->query("SELECT * FROM tb_soal_skd WHERE subtes = 6 AND nomor_soal='$rdr' ");
		return $query->row();
	}

	public function get_skd_subtes_7($rdr)
	{
		$query = $this->db->query("SELECT * FROM tb_soal_skd WHERE subtes = 7 AND nomor_soal='$rdr' ");
		return $query->row();
	}

	public function get_skd_subtes_8($rdr)
	{
		$query = $this->db->query("SELECT * FROM tb_soal_skd WHERE subtes = 8 AND nomor_soal='$rdr' ");
		return $query->row();
	}

	public function insert_jawaban_skd($paket)
	{
		$this->db->insert('tb_data_jawaban_skd', $paket);
		return $this->db->affected_rows();
	}
	...
	public function jawaban_studi2($paket)
	{
		$this->db->insert('tb_jawaban_studi2', $paket);
		return $this->db->affected_rows();
	}
	...
	//Data TKP
	public function get_questions_tkp($rdr)
	{
		$query = $this->db->query("SELECT * FROM tb_soal_tkp WHERE id_soal='$rdr' ");
		return $query->row();
	}

	public function insert_jawaban_tkp($paket)
	{
		$this->db->insert('tb_data_jawaban_tkp', $paket);
		return $this->db->affected_rows();
	}

	//Data Cepat
	public function get_questions_cepat($rdr)
	{
		$query = $this->db->query("SELECT * FROM tb_soal_cepat WHERE id_soal='$rdr' ");
		return $query->row();
	}

	public function insert_jawaban_cepat($paket)
	{
		$this->db->insert('tb_data_jawaban_cepat', $paket);
		return $this->db->affected_rows();
	}

	//Data tray
	public function get_questions_tray($rdr)
	{
		$query = $this->db->query("SELECT * FROM tb_soal_tray WHERE id_soal='$rdr' ");
		return $query->row();
	}

	public function insert_jawaban_tray($paket)
	{
		$this->db->insert('tb_data_jawaban_tray', $paket);
		return $this->db->affected_rows();
	}

	public function jawaban_tray($paket)
	{
		$this->db->insert('tb_data_jawaban_tray', $paket);
		return $this->db->affected_rows();
	}
	...
	//Data Army
	public function get_questions_army($rdr)
	{
		$query = $this->db->query("SELECT * FROM tb_soal_army WHERE id_soal='$rdr' ");
		return $query->row();
	}

	public function insert_jawaban_army($paket)
	{
	...
	public function get_holland_results()
	{
		$this->db->select('*');
