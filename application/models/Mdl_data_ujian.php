...
class Mdl_data_ujian extends CI_Model
{
	...
	{
		$query = $this->db->query("SELECT * FROM tb_ujian_skd");
		return $query->result_array();
	}
	...
	public function ambildata_ujian_paps_ugm()
	{
		$query = $this->db->query("SELECT * FROM tb_ujian_paps_ugm");
		return $query->result_array();
	}
	...
	{
		$query = $this->db->query("SELECT * FROM tb_ujian_tray");
		return $query->result_array();
	}
	public function ambildata_ujian_army()
	{
		$query = $this->db->query("SELECT * FROM tb_ujian_army");
		return $query->result_array();
	}
	...
	public function ambildata_ujian_studi2()
	{
		$query = $this->db->query("SELECT * FROM tb_ujian_kasus2");
		return $query->result_array();
	}
	...
	public function ambildata_ujian_tkp()
	{
		$query = $this->db->query("SELECT * FROM tb_ujian_tkp");
		return $query->result_array();
	}
	...
	{
		$query = $this->db->query("SELECT * FROM tb_ujian_skd  WHERE id_ujian_skd=$id");
		return $query->result_array();
	}
	...
	public function tambahdata_ujian_skd($paket)
	{
		$this->db->insert('tb_ujian_skd', $paket);
		return $this->db->affected_rows();
	}
	...
	public function tambahdata_ujian_cepat($paket)
	{
		$this->db->insert('tb_ujian_cepat', $paket);
		return $this->db->affected_rows();
	}
	public function tambahdata_ujian_tray($paket)
	{
		$this->db->insert('tb_ujian_tray', $paket);
		return $this->db->affected_rows();
	}
	public function tambahdata_ujian_army($paket)
	{
		$this->db->insert('tb_ujian_army', $paket);
		return $this->db->affected_rows();
	}
	...
	public function tambahdata_ujian_studi2($paket)
	{
		$this->db->insert('tb_ujian_kasus2', $paket);
		return $this->db->affected_rows();
	}
